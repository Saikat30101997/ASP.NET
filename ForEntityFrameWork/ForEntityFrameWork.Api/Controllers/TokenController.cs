...
namespace ForEntityFrameWork.Api.Controllers
{
        ...
        public async Task<IActionResult> Get(string email, string password)
        {
            if (email != null && password != null)
            {
                ...
                if (result != null && result.Succeeded)
                {
                    ...
                    {
                        Subject = new System.Security.Claims.ClaimsIdentity((await _userManager.GetClaimsAsync(user)).ToArray()), //user er claim ta subject akare tule anchi joto claim ache shb gula e array akare dia disi

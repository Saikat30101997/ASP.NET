...
using ForEntityFrameWork.Membership.BusinessObjects;
...
namespace ForEntityFrameWork.Api
{
    public class Startup
    {
        ...
        {
            {
                ...
                {
                    c.SwaggerDoc("v1", new OpenApiInfo { Title = "ForEntityFrameWork.Api", Version = "v1" });
                });
            }
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "ForEntityFrameWork.Api v1"));
            }
